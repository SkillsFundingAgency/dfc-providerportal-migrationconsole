...
namespace Dfc.CourseDirectory.Services.VenueService
{
    public class VenueService : IVenueService
    {
        ...
        public async Task<IResult<IVenue>> GetVenueByVenueIdAsync(IGetVenueByVenueIdCriteria criteria)
        {
            ...
            try
            {
                ...
                var content = new StringContent(criteria.ToVenueIdJson(), Encoding.UTF8, "application/json");
    ...
    {
        internal static string ToVenueIdJson(this IGetVenueByVenueIdCriteria extendee)
        {
